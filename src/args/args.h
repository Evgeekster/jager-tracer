...
typedef enum {
    ...
    /* --- networking --- */
    ARG_SOCKADDR,   /* struct sockaddr * (needs paired addrlen arg)      INPUT PARAMETER */
    ...
    ARG_SOCKADDR_OUT,  /* output: recvfrom, accept, getsockname, getpeername OUT PARAMETER */
...
/* --- THE FOLLOWING PARTS ARE AUTOGENERATED BY scripts/py/gen_sockopts.py ---*/ 

extern const NamedConst sockopt_name_sol_socket[];
extern const NamedConst sockopt_name_tcp[];
extern const NamedConst sockopt_name_ip[];
